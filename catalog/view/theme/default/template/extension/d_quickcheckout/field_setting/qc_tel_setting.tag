        ...
        <div class="qc-setting-tab-content"> 
            <div class="qc-setting-tab-pane fade in active" role="tabpanel" id="{ opts.setting_id }_general" aria-labelledby="{ opts.setting_id }_general_tab"> 
                <div class="ve-editor__setting__content__section">
                    ...
                    <div class="ve-field">
                        <label class="ve-label">{ getLanguage().general.text_mask}</label>
                        <input onchange="{parent.edit}" type="text" class="ve-input" name="config[{getAccount()}][{opts.step}][fields][{ opts.field_id }][mask]" value={ opts.field.value } />
                    </div>

                    <div class="ve-field" >
                        <label class="ve-label">{getLanguage().general.text_telephone_validation}</label>
                        <div>
                            <qc_switcher onclick="{parent.edit}" name="config[{getAccount()}][{opts.step}][fields][{ opts.field_id }][validation]" data-label-text="Enabled" value="{ opts.field.validation }" />
                        </div>
                    </div>

                    <div class="ve-field">
                        <label class="ve-label">{ getLanguage().general.text_telephone_countries}</label>
                        <input onchange="{parent.edit}" type="text" class="ve-input" name="config[{getAccount()}][{opts.step}][fields][{ opts.field_id }][countries]" value={ opts.field.countries } />
                    </div>

                    <div class="ve-field" if={opts.field.custom}>
                        <label class="ve-label">Switch type</label>
                        <select onchange="{parent.editType}" class="ve-input" name="config[{getAccount()}][{opts.step}][fields][{ opts.field_id }][type]">
                            <option value="text">text</option>
                            <option value="tel" selected>telephone</option>
                        </select>
                    </div>
                </div>
            </div>
