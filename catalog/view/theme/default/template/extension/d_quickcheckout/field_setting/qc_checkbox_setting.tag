<qc_checkbox_setting>
    ...
    <qc_setting 
        ...
        <div class="qc-setting-tab-content"> 
                ...
                <div class="ve-editor__setting__content__section">
                    ...
                    <div class="ve-field">
                        ...
                        <div class="ve-input-group">
                            ...
                            <input onchange="{parent.edit}" type="text" class="ve-input" name="language[{ opts.step }][{ opts.field.text }]" value={ raw(getLanguage()[opts.step][opts.field.text]) } />
                        </div>
                    </div>
                    ...
                    <div class="ve-field">
                        ...
                        <div>
                            <qc_switcher onclick="{parent.edit}" name="config[guest][{opts.step}][fields][{ opts.field_id }][value]" data-label-text="Enabled" value={ opts.field.value }/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- <div class="tab-pane fade" role="tabpanel" id="{ opts.setting_id }_design" aria-labelledby="{ opts.setting_id }_design_tab">
