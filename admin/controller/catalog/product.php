...
class ControllerCatalogProduct extends Controller {
	...
	public function deleteProduct(){
		...
		if (isset($this->request->get['productID']) && $this->validateDelete()) {
			$this->model_catalog_product->deleteProduct($this->request->get['productID']);
			$this->session->data['success'] = $this->language->get('text_success');
	...
	protected function getListBySupplier(){
		if (isset($this->request->get['filter_name'])) {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['bent_count'])) {
			$data['bent_count'] = $this->request->post['bent_count'];
		} elseif (!empty($product_info)) {
			$data['bent_count'] = $product_info['bent_count'];
		} else {
			$data['bent_count'] = 1;
		}
