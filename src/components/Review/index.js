...
import { Languages, Color, Events, Tools } from "@common";
...
class Review extends PureComponent {
  ...
  submitComment = () => {
    const { cookie, post, user } = this.props;
    const self = this;
    ...
    OpencartWorker.postReview(post.id, Tools.getName(user), this.state.txtComment, this.state.starCount)
      .then(() => {
        self.setState({
          addComment: true,
          txtComment: "",
